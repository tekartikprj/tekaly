...
void runSyncedSourceTest(Future<SyncedSource> Function() createSyncedSource) {
  ...
  test('putRecord', () async {
    var record = (await source.putSourceRecord(SyncedSourceRecord()
    ...
    record = (await source.putSourceRecord(SyncedSourceRecord()
      ..record.v = (SyncedSourceRecordData()
        ..store.v = 'test'
        ..key.v = '1')
      ..syncId.v = syncId))!;
  ...
  test('getRecord', () async {
    ...
    // Without syncId
    record = (await source
        .getSourceRecord(SyncedDataSourceRef(store: 'test', key: '1')))!;
    expect(record.syncId.v, newSyncId);
    // Wrong syncId
    record = (await source
        .getSourceRecord(SyncedDataSourceRef(store: 'test', key: '1')))!;
  ...
  test('getSourceRecordList', () async {
    ...
    var record2 = await source.putSourceRecord(SyncedSourceRecord()
      ..record.v = (SyncedSourceRecordData()
        ..store.v = 'test'
        ..key.v = '2'));
    list = await source.getSourceRecordList(includeDeleted: true);
